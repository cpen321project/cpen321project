(async () => {
    ...
    const { userAddedNotification } = require("./controllers/firebase.js")
    ...
    app.post("/addusertocourse", async (req, res) => {
        try {
            ...
            // call firebase user added with userID
            // firebase.database().ref('/users/' + req.body.userID).set({
            //     displayName: req.body.displayName,
            //     userID: req.body.userID,
            //     courselist: [req.body.coursename]
            // })
        }
        catch (err) {
            console.log(err)
    ...
    app.post("/addcoursetouser", async (req, res) => {
        userCollection.updateOne({ "userID": req.body.userID }, { $push: { "courselist": req.body.coursename } }, (err, result) => {
            ...
            await userAddedNotification(req.body.userID, req.body.coursename)
        });
    })
