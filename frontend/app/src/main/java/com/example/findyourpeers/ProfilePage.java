...
public class ProfilePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String urltest = "http://localhost:3010/getuserprofile/"+userID;
    ...
    private void deleteUserfromCourse(String courseNameSingle, String userID) {
        ...
        String urlUserToCourse = "http://localhost:3010/deleteuserfromcourse"+"/"+userID+"/"+coursenameNoSpace;
    ...
    private void deleteCoursefromUser(String courseNameSingle, String userID) {
        ...
        String url = "http://localhost:3010/deletecoursefromuser";
